                ...
                <ModalBody>
                    <form action="">
                        <div className="form-group form-floating mb-3">
                            ...
                            <input type="text" id="floatingInput" class="form-control" placeholder="Edit Title"
                                value={taskName} onChange={handleChange} name="taskName" />
                        </div>
                        <div class="form-floating">
                            <label for="floatingTextarea">Description</label>
                            <textarea class="form-control" placeholder="Add Precise Description here:" id="floatingTextarea" value={desc}
